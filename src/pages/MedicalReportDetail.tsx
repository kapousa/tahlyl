  ...
  if (!test) {
    return (
      <div className="text-center py-8">
        ...
        <p className="text-muted-foreground mb-6">The requested medical report could not be found.</p>
        <Button asChild>
          <Link to="/bloodtests">
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center">
        ...
        <h1 className="text-2xl font-bold tracking-tight">Medical Report Details</h1>
      </div>
